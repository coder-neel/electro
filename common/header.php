<header class="header d-blue-bg">
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="header-inner-start">
                            ...
                            <div class="support d-none d-sm-block">
                                <p>Need Help? <a href="tel:+919664227080">(+91)-9664227080</a></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                        <div class="header__info">
                            <div class="logo">
                                <a href="index.html" class="logo-image"><img src="assets/img/logo/logo1.svg"
                                        alt="logo"></a>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Section: End: Header Mid -->

    <!-- Section: Start: Header Bottom -->
                            ...
                            <div class="cat__menu-2 cat__menu">
                                <nav id="mobile-menu" style="display: block;">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="product.html">Phone and Electronics <i
                                                    class="far fa-angle-down"></i></a>
                                        ...
                                        <li class="d-laptop-none"><a href="product.html">Jewelry &amp; Watches</a>
                                        </li>
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="about.html">About Us</a></li>
                                    <li class="has-mega"><a href="shop.html">Shop <i
                                                class="far fa-angle-down"></i></a>
                                        <div class="mega-menu">
